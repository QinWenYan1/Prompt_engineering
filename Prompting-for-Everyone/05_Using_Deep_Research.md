...
- [*知识点3: 并行搜索——Deep Research 高效的技术原因*](#id3)

---

## 🧠 本课核心

Deep Research 是一种**Agentic AI**——AI 不只是回答，而是自主规划研究路径、并行搜索数十个来源、迭代深化、最终生成带引用的报告。但它需要数分钟，所以你必须**主动选择**使用它。
...
| 4. 迭代深化 | 阅读页面、综合学习，决定是否继续搜索 | 等待 |
| 5. 生成报告 | 输出带引用的详细研究报告 | 阅读、验证 |

**为什么叫 Agentic AI**
> AI 在「决定下一步搜索什么」方面有自主权——它不是一个被动的问答机器，而是一个主动的研究者。

**Andrew Ng 的例子：万圣节鬼屋策划**
- 输入：位置、前院面积、想要的体验类型
...
> "Web search 适合我用几秒钟、查几个来源就能完成的工作。Deep Research 适合需要阅读最新科学文章并深入思考的问题——不能让 AI 只取互联网上的流行答案。"
...
<a id="id3"></a>
## ✅ 知识点3: 并行搜索——Deep Research 高效的技术原因
...
- 问自己：这个问题需要看多少篇文章才能回答？
  - 1-3 篇 → Web Search
  - 10+ 篇 + 综合分析 → Deep Research
- 用 Deep Research 时，**检查 AI 提出的研究计划**，确认方向正确再让它跑
- Deep Research 的报告有引用——善用引用追溯到原始来源验证

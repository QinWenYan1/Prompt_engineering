...
- [*知识点2: METR 研究——AI 能力的增长轨迹*](#id2)
- [*知识点3: AI 的推理循环——罗马地标案例*](#id3)
- [*知识点4: 如何触发延长推理*](#id4)
...
现代 AI 不只是「预测下一个词」——它可以像一个研究员一样**长时间深度推理**复杂问题。本课最重要的信息：「think step-by-step」已经过时了，现在你只需要说 **「think hard」**。
...
**Andrew Ng 的原话**
> "I no longer tell my AI model to think step-by-step. Instead, I'm more likely to just tell it to think hard."
...
**关键洞察**
> AI 不需要像人类那样花 10 小时完成任务，但它也确实需要比「几秒钟」更长的时间来推理。

**注意点**
- 💡 AI 的推理时间门槛在逐年上移——2025 年的模型已经能在数小时级的人类任务上取得不错的成功率
- 🔄 这和上一课的 Deep Research 完全对应——Agentic AI 正在把推理 + 搜索 + 工具调用整合起来

---

<a id="id3"></a>
## ✅ 知识点3: AI 的推理循环——罗马地标案例
...
- 需要深度分析时，在 prompt 末尾加一句：
  ```
  Think really hard about this. Take your time.
  ```
- 不要只用免费的/旧模型做推理任务——模型代际差距巨大
- 把 AI 当实习生测试：给它一个你花了半天完成的任务，看它能不能做到 80%
